...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-add-item-form></app-add-item-form>\n<app-shopping-cart></app-shopping-cart>");
...
let AddItemFormComponent = class AddItemFormComponent {
    ...
    submitForm() {
        if (this.itemName && this.itemPrice > 0) {
            const newItem = { id: this.generateUniqueId(), name: this.itemName, price: this.itemPrice };
...
AddItemFormComponent.ctorParameters = () => [
    { type: _cart_service_service__WEBPACK_IMPORTED_MODULE_2__["CartServiceService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], AddItemFormComponent.prototype, "editItem", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], AddItemFormComponent.prototype, "addItem", void 0);
...
let CartServiceService = class CartServiceService {
    ...
    updateItem(oldItem, newItem) {
        const currentItems = this.itemsSubject.getValue();
        const updatedItems = currentItems.map(item => (item === oldItem ? newItem : item));
        this.itemsSubject.next(updatedItems);
    }
};
