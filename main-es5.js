...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/"./node_modules/raw-loader/dist/cjs.js!./src/app/add-item-form/add-item-form.component.html":
  /*!**************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/add-item-form/add-item-form.component.html ***!
    \**************************************************************************************************/
  /*! exports provided: default */
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAddItemFormAddItemFormComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";

    __webpack_require__.r(__webpack_exports__);
    /* harmony default export */
    __webpack_exports__["default"] = "<h3>{{ editItem ? 'Edit Item' : 'Add Item' }}</h3>\n<form (ngSubmit)=\"submitForm()\">\n  <label for=\"itemName\">Item Name:</label>\n  <input id=\"itemName\" type=\"text\" [(ngModel)]=\"itemName\" name=\"itemName\" required>\n\n  <label for=\"itemPrice\">Item Price:</label>\n  <input id=\"itemPrice\" type=\"number\" [(ngModel)]=\"itemPrice\" name=\"itemPrice\" required>\n\n  <button type=\"submit\">{{ editItem ? 'Update Item' : 'Add Item' }}</button>\n</form>\n";
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.r(__webpack_exports__);
    /* harmony default export */
    __webpack_exports__["default"] = "<app-add-item-form></app-add-item-form>\n<app-shopping-cart></app-shopping-cart>";
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppShoppingCartShoppingCartComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.r(__webpack_exports__);
    /* harmony default export */
    __webpack_exports__["default"] = "<h2>Shopping Cart</h2>\n<!-- <button (click)=\"showAddForm = true\">Add Item</button> -->\n\n<ul>\n  <li *ngFor=\"let item of items; let i = index\">\n    {{ item.name }} - {{ item.price | currency }}\n    <button (click)=\"removeItem(item)\">Remove</button>\n    <button (click)=\"editItem(i)\">Edit</button>\n  </li>\n</ul>\n\n<app-add-item-form *ngIf=\"showAddForm\" (addItem)=\"addItem($event)\"></app-add-item-form>\n<app-add-item-form *ngIf=\"showEditForm\" [editItem]=\"items[selectedIndex]\" (addItem)=\"updateItem($event)\"></app-add-item-form>\n";
  ...
  /***/"./src/app/add-item-form/add-item-form.component.css":
  /*!***********************************************************!*\
    !*** ./src/app/add-item-form/add-item-form.component.css ***!
    \***********************************************************/
  /*! exports provided: default */
  /***/
  function srcAppAddItemFormAddItemFormComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAddItemFormAddItemFormComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _cart_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__( /*! ../cart-service.service */"./src/app/cart-service.service.ts");
    var AddItemFormComponent = /*#__PURE__*/function () {
      function AddItemFormComponent(cartService) {
      ...
      _createClass(AddItemFormComponent, [{
        ...
        value: function generateUniqueId() {
          return this.idCounter++; // Increment the counter for each new ID
        }
      }, {
        key: "submitForm",
    ...
    AddItemFormComponent.ctorParameters = function () {
      return [{
        type: _cart_service_service__WEBPACK_IMPORTED_MODULE_2__["CartServiceService"]
      }];
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], AddItemFormComponent.prototype, "editItem", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], AddItemFormComponent.prototype, "addItem", void 0);
    AddItemFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-add-item-form',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__( /*! raw-loader!./add-item-form.component.html */"./node_modules/raw-loader/dist/cjs.js!./src/app/add-item-form/add-item-form.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__( /*! ./add-item-form.component.css */"./src/app/add-item-form/add-item-form.component.css"))["default"]]
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _shopping_cart_shopping_cart_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__( /*! ./shopping-cart/shopping-cart.component */"./src/app/shopping-cart/shopping-cart.component.ts");
    /* harmony import */
    var _add_item_form_add_item_form_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__( /*! ./add-item-form/add-item-form.component */"./src/app/add-item-form/add-item-form.component.ts");
    /* harmony import */
    ...
    /* harmony import */
    var _cart_service_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__( /*! ./cart-service.service */"./src/app/cart-service.service.ts");
    var AppModule = /*#__PURE__*/_createClass(function AppModule() {
      _classCallCheck(this, AppModule);
    });
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _shopping_cart_shopping_cart_component__WEBPACK_IMPORTED_MODULE_5__["ShoppingCartComponent"], _add_item_form_add_item_form_component__WEBPACK_IMPORTED_MODULE_6__["AddItemFormComponent"]],
  ...
  function srcAppCartServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CartServiceService = /*#__PURE__*/function () {
      ...
      _createClass(CartServiceService, [{
        ...
        value: function addItem(item) {
          var currentItems = this.itemsSubject.getValue();
          var updatedItems = [].concat(_toConsumableArray(currentItems), [item]);
        ...
        key: "updateItem",
        value: function updateItem(oldItem, newItem) {
          var currentItems = this.itemsSubject.getValue();
    ...
    CartServiceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], CartServiceService);
  ...
  function _(module, exports, __webpack_require__) {
    module.exports = __webpack_require__( /*! E:\Angular\assignment\task\src\main.ts */"./src/main.ts");
